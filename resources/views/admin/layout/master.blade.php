                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('order#list') }}">
                                <i class="fa-solid fa-sort"></i>Order</a>
                        </li>
                        <li>
                            <a href="{{ route('userList') }}">
                                <i class="fa-solid fa-sort"></i>User List</a>
                        </li>
                        <li>
                            <a href="{{ route('contact#show') }}">
                                <i class="fa-solid fa-sort"></i>User Message</a>
                        </li>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            ...
                                            alt="Cool Admin" />
                                            @else
                                                <img src="{{ asset('storage/'. Auth::user()->image) }}" class="rounded-circle img-thumbnail"
                                                    alt="Cool Admin" />
                                            @endif
                                        </div>
                                        <div class="content">
